...
import SwitchFormTab from "../atoms/switchFormTab";
import Button from "../atoms/button";
import { useRouter } from "next/router";
import { ProgramsContext } from "../context/programs";
import SwitchSquareTab from "../atoms/switchSquareTab";
...
export default function ProgramsCatalog() {
    ...
    useEffect(() => {
        ...
        setFilteredData(arr)
    }, [activeNavTab, activeSwitchTab, activeTrainingTab, activeEducationTab, activeSwitchFormsTab, activeSwitchForms2Tab ])
    ...
    return (
        <>
            <GridContainer>
                <h2 id="catalog" className="lg:col-span-12 md:col-span-8 col-span-4 font-firaSans font-bold lg:text-4xl-l text-2xl text-main-black-text relative">
                ...
                <div className="lg:col-span-9 md:col-span-8 col-span-4 flex flex-col lg:mt-8.5 mt-2">
                    <div className="md:flex hidden w-full justify-between space-x-4">
                        {navTabs.map((item, index) =>
                            <NavTab
                                key={index}
                                active={index === activeNavTab}
