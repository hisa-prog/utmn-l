...
export default function ProjectsCatalog() {
  ...
  useEffect(() => {
    ...
    setFilteredData(arr)
  }, [activeNavTab, activeLearningTab, activeQualificationTab, activePriceTab])
  ...
  return (
    <>
      <GridContainer>
        ...
        {/* mobile menu */}
        <div className={`${openFilters ? 'flex' : 'hidden'} z-10 fixed top-12 h-full bg-white flex-col lg:hidden right-0 md:w-1/2 w-full p-4`}>
